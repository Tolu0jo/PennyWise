...
import { FormContainer, FormGroup, Label, Input, Button, CustomFileInputWrapper, CustomFileInputText, HiddenFileInput } from "./AddAccountStyle";
...
const AddAccountModal: React.FC<AddAccountModalProps> = () => {
  ...
  const handleChange = (
    ...
    if (type === "file") {
      ...
      const newValue = name === "accountNumber" || name === "bvn" ? Number(value) : value;
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.identification) {
        toast.error("Valid means of identification is required.");
        return;
      }
